import{a as o,r,i as d}from"./sidebar-CLg1KTqr.js";import{a as l}from"./index-DBnBgkrA.js";import{toast as c}from"./toast-CQ5lsFjN.js";const m=[{id:"rooms",icon:"fa-door-open",label:"Rooms"},{id:"payments",icon:"fa-credit-card",label:"Payments"},{id:"settings",icon:"fa-gear",label:"Settings"}],g={_activeTab:"rooms",async mount(t){if(!l.isAdmin()){t.innerHTML=`
        ${r("/admin-config")}
        <main class="content">
