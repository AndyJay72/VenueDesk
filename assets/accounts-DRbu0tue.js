import{a as v,r as y,i as b}from"./sidebar-Dqc3A8_t.js";import{toast as _}from"./toast-CQ5lsFjN.js";import"./index-B757bbVY.js";function i(a){return"£"+(parseFloat(a)||0).toLocaleString("en-GB",{minimumFractionDigits:2,maximumFractionDigits:2})}function g(a){return a?new Date(a).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—"}const F={async mount(a){a.innerHTML=`
      ${y("/accounts")}
      <main class="content">
