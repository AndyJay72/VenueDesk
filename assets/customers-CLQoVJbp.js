import{r as m,i as c,a as u}from"./sidebar-CTXXJD_F.js";import"./index-C4GfeYAM.js";function h(s){return s?new Date(s).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—"}const y={async mount(s){s.innerHTML=`
      ${m("/customers")}
      <main class="content">
