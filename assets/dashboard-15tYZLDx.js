import{a as o,r as g,i as p}from"./sidebar-C6JJCDNJ.js";import{a as u}from"./index-BLFn9FJy.js";function l(t,a="£"){const i=parseFloat(t)||0;return a+i.toLocaleString("en-GB",{minimumFractionDigits:2,maximumFractionDigits:2})}function c(t){return t?new Date(t).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—"}function m(t){return`<span class="badge badge-${{confirmed:"success",pending:"warning",cancelled:"danger",completed:"info",fully_paid:"success"}[t]||"muted"}">${t||"—"}</span>`}const f={async mount(t){t.innerHTML=`
      ${g("/dashboard")}
