import{a as u,r as h,i as f}from"./sidebar-CTXXJD_F.js";import{toast as b}from"./toast-CQ5lsFjN.js";import"./index-C4GfeYAM.js";function n(a){return"£"+(parseFloat(a)||0).toLocaleString("en-GB",{minimumFractionDigits:2,maximumFractionDigits:2})}function v(a){return a?new Date(a).toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"}):"—"}const x={async mount(a){a.innerHTML=`
      ${h("/accounts")}
      <main class="content">
