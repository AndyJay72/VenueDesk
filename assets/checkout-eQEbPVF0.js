import{a as y,n as u,r as f,i as b}from"./sidebar-CTXXJD_F.js";import{a as g}from"./index-C4GfeYAM.js";import{toast as m}from"./toast-CQ5lsFjN.js";function h(){const t=window.location.hash,e=t.indexOf("?");return e===-1?{}:Object.fromEntries(new URLSearchParams(t.slice(e+1)))}const P={async mount(t){const{booking_id:e,amount:r,description:i,status:n}=h();t.innerHTML=`
      ${f("/checkout")}
      <main class="content">
