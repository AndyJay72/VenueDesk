import{a as m,r as u,i as p}from"./sidebar-Dqc3A8_t.js";import{toast as f}from"./toast-CQ5lsFjN.js";import"./index-B757bbVY.js";function v(e){return e?new Date(e).toLocaleString("en-GB",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}):"—"}const g={info:"info",warn:"warning",error:"danger"},w={async mount(e){e.innerHTML=`
      ${u("/audit-log")}
      <main class="content">
